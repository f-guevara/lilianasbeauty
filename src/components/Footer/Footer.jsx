      ...
      <section className="container">
        <div className="grid md:grid-cols-3 py-5 gap-6">
          ...
          <div className="py-8 px-4">
            <h1 className="sm:text-3xl text-xl font-bold mb-3 font-serif">Liliana Beauty Salon</h1>
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a href="https://maps.app.goo.gl/yxo3UB28XJgN78Tu6" target="_blank" rel="noopener noreferrer">
                <FaMapMarkerAlt className="text-3xl hover:text-primary duration-300" />
              </a>
              <a href="https://wa.me/5035555555" target="_blank" rel="noopener noreferrer">
