        ...
        min-h-[620px] flex'>
            ...
            grid-cols-1 sm:grid-cols-2'>
                ...
                space-y-5 sm:pr-32'>
                        ...
                        data-aos='fade-up'
                        data-aos-delay='600'
                        className='text-5xl lg:text-7xl font-semibold font-serif'>Consentirte</h1>
                        <p
                        data-aos='fade-up'
                        data-aos-delay='1000'
                        >Descubre un mundo de atención personalizada 
                            ...
                            duration-300 font-bold'>Reservaciones</button>
